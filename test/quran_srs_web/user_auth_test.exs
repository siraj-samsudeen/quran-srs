defmodule QuranSrsWeb.UserAuthTest do
  use QuranSrsWeb.ConnCase, async: true

  alias QuranSrs.Accounts
  alias QuranSrs.Accounts.Scope
  alias QuranSrsWeb.UserAuth

  import QuranSrs.AccountsFixtures

  @remember_me_cookie "_quran_srs_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, QuranSrsWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
